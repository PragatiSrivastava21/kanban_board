...
if (isDragging){
    ...
    ref={setNodeRef}
    style={style}
    className="opacity-50 bg-mainBackgroundColor relative p-2.5 h-[100px] min-h-[100px] items-center flex text-left rounded-xl border-2  border-rose-500 cursor-grab"> 
         </div>
}
 ...
 if(editMode){
   ...
   {...listeners}
    ...
    return (
      ...
      className="absolute opacity-60 hover:opacity-100 right-4  bg-columnBackgroundColor p-2"
       ><TrashIcon /></button>)}
       </div> 
    );
}
